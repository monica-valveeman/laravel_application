...
<html>
    ...
    <body>
        ...
        <div class="div1">
        <h1>Edit User</h1>    
            <form id="userform" action="{{route('user.update','$users->id')}}" method="POST" enctype="multipart/form-data">
            @method('PUT')    
            <table>
                    <tr>
                    ...
                    <td align="left">
                        <select name="year_of_experience" value="{{$education->year_of_experience}}">
                ...
                <tr>
                    ...
                    <td align="left">
                        <select name="under_graduate" value="{{$education->under_graduate}}">
                ...
                <tr>
                    ...
                    <td align="left">
                        <select name="post_graduate" value="{{$education->post_graduate}}">
